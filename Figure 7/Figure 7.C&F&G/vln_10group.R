...
######### 
 aa1<-c('ARX','MAFA','CHL1')
r=1
pdf('vlnplot_0806_1-4.pdf',width = 5,height = 3)
VlnPlot(ss_obj,features =aa1[r],
        group.by = 'vlnplot_group',cols=rep(c("#add8e6","#ee5e49"),10),
        pt.size=0.1,ncol=1 )+NoLegend()
r=r+1
dev.off()

################
pdf('vlnplot_0806_5-9.pdf',width = 5,height = 3)
aa<-c('RFX6','PFKFB2','CREB1')
i=1
...
#########3
pdf('dediff_imma-0806.pdf',width = 5,height = 3)
